...
export function LoginForm({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-6 justify-center items-center min-h-screen w-full bg-linear-to-br from-slate-900 via-blue-950 to-indigo-950",
        className,
      )}
      {...props}
    >
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <Input
                  ...
                  className="bg-slate-800/50 border-blue-700/30 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500/50 backdrop-blur-sm"
                />
              </Field>
              <Field>
              ...
              <FieldSeparator className="*:data-[slot=field-separator-content]:bg-slate-800/50 *:data-[slot=field-content]:text-slate-500" />
              ...
              <div className="text-center text-sm text-slate-400 relative z-20 isolate">
